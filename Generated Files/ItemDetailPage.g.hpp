...
void ::Somability_UI::ItemDetailPage::InitializeComponent()
{
    if (_contentLoaded)
        return;
...
void ::Somability_UI::ItemDetailPage::Connect(int connectionId, Platform::Object^ target)
{
    switch (connectionId)
    {
    case 1:
        (safe_cast<::Windows::UI::Xaml::UIElement^>(target))->PointerMoved +=
            ref new ::Windows::UI::Xaml::Input::PointerEventHandler(this, (void (::Somability_UI::ItemDetailPage::*)(Platform::Object^, Windows::UI::Xaml::Input::PointerRoutedEventArgs^))&ItemDetailPage::OnPointerMoved);
        (safe_cast<::Windows::UI::Xaml::UIElement^>(target))->PointerReleased +=
            ref new ::Windows::UI::Xaml::Input::PointerEventHandler(this, (void (::Somability_UI::ItemDetailPage::*)(Platform::Object^, Windows::UI::Xaml::Input::PointerRoutedEventArgs^))&ItemDetailPage::OnPointerReleased);
        break;
    }
